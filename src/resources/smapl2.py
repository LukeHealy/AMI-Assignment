...
if priority_queue->is_empty() or  !priority_queue:
#    return;
...
if succ->depth() >= max_depth and  !succ->goal_p() :
...
num_states_in_queue -= 1
            
if num_states_on_queue > max_states:
